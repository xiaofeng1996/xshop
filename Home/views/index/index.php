...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>public/home/css/shop_header.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/home/css/shop_home.css" type="text/css" />
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>public/home/js/focus.js" ></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/home/js/shop_home_tab.js" ></script>
</head>
...
<body>
	...
	<div class="shop_hd">
		...
		<?php require_once "Home/views/pub/left.php"; ?>
		<!-- Header Menu End -->
	...
	<div class="shop_bd clearfix">
            ...
            <div class="shop_bd_top clearfix">
                ...
                <div class="shop_bd_top_center">
                    ...
                    <div class="xifan_sub_box">
                      ...
                      <div id="xifan_bd1lfimg">
                        <div>
                          <dl class=""></dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="<?php echo base_url(); ?>public/home/images/e2dfe57add8fff66ed0964b1effd39b9.jpg" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="<?php echo base_url(); ?>public/home/images/e50b5d398e3b890f08e14defbc71a94d.jpg" alt="潜入城市周边清幽之地"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">潜入城市周边清幽之地</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="<?php echo base_url(); ?>public/home/images/196b173f15685a2019ab3396cd1851a4.jpg" alt="盘点中国最美雪山"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">盘点中国最美雪山</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="<?php echo base_url(); ?>public/home/images/e81345cbc3d8a7e11f9a0e09df68221d.jpg" alt="2011西安世园会攻略"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011西安世园会攻略</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="<?php echo base_url(); ?>public/home/images/65662b58848da87812ba371c7ff6c1ad.jpg" alt="五月乐享懒人天堂塞班岛"></a></dt>
                    ...
                    <!-- 图片切换  end --> 
                    <div class="clear"></div>
                    <div class="shop_bd_top_center_hot"><img src="<?php echo base_url(); ?>public/home/images/index.guanggao.png" /></div>
                </div>
            ...
            <div class="shop_bd_home_block clearfix">
                ...
                <div class="shop_bd_home_block_left">
                    ...
                    <div class="shop_hd_home_block_left_class clearfix">
                        <dl class="clearfix">
                            <dt>女装</dt>
                            <dd>
                                <a href="<?php echo site_url('goods/goods'); ?>">棉衣</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">毛呢大衣</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">风衣</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">打底衫</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">情侣装</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">毛呢短裤</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">牛仔裤</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">加绒打...</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">小脚裤</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">半身裙</a>
                            </dd>
                        </dl>
                        ...
                        <dl class="clearfix">
                            <dt>男装</dt>
                            <dd>
                                <a href="<?php echo site_url('goods/goods'); ?>">羽绒服</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">卫衣</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">长袖T桖</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">长袖衬衫</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">风衣</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">休闲西装</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">棉衣</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">休闲长裤</a>
                                <a href="<?php echo site_url('goods/goods'); ?>">内衣内裤</a>
                            </dd>
                        </dl>
                        
                    </div>
                    <div class="shop_bd_home_block_left_pic">
                        <a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png"/></a>
                    </div>
                </div>
                <!-- 左边 End -->
                ...
                <div class="shop_bd_home_block_right">
                    ...
                    <ol class="saletop-list">
                        <li class="top clearfix">
                            <dl>
                                <dt class="goods-name">
                                    <a href="<?php echo site_url('goods/goods'); ?>">正品都市时尚女装假两件优雅针</a>
                                </dt>
                                <dd class="nokey">1</dd>
                                <dd class="goods-pic">
                                    <a href="<?php echo site_url('goods/goods'); ?>"><span class="thumb size60"><img src="images/3f81874d594894d19150843c42fb1f8e.jpg_small.jpg" /></span></a>
                                </dd>
                        ...
                        <li class="normal">
                            <i>4</i>
                            <a href="<?php echo site_url('goods/goods'); ?>">2011秋冬新款韩版大码毛领毛呢外套呢子大衣【演示数据】</a>
                        </li>
                        <li class="normal">
                            <i>5</i>
                            <a href="<?php echo site_url('goods/goods'); ?>">2011秋冬新款韩版大码毛领毛呢外套呢子大衣【演示数据】</a>
                    ...
                    <div class="saletop-list_adv_pic"><a href="<?php echo site_url('goods/goods'); ?>"><img src="images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a></div>
                </div>
                <!-- 右边商品排行 -->
                ...
                <div class="shop_bd_home_block_bottom">
                    <ul class="">
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
                        <li><a href="<?php echo site_url('goods/goods'); ?>"><img src="<?php echo base_url(); ?>public/home/images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
                    </ul>
                </div>
                <!-- 品牌展示 End -->
