		...
		<div class="shop_gwc_bd_contents clearfix">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td class="gwc_list_pic"><a href=""><img src="<?php echo base_url(); ?>public/home/images/4_7b5239c3f153ae4b67ff760f54408a5b.jpg_tiny.jpg" /></a></td>
					...
					<tr>
						<td colspan="6">
							...
							<div class="gwc_foot_links">
								...
								<a href="<?php echo site_url('order/order') ?>" class="op">确认收货地址</a>
							</div>
						</td>
					</tr>
				</tfoot>
